...
export const FREE_VIDEOS_TOTAL = 2; // Lifetime free videos
export const PRO_MONTHLY_CAP = 50; // Max videos per month on Pro plan
export const ENTERPRISE_MONTHLY_CAP = 500; // Max videos per month on Enterprise plan
