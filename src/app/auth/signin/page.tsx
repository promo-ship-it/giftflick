...
import { Play, Mail, Lock, Loader2, ArrowRight, Eye, EyeOff } from "lucide-react";
    ...
    <div className="min-h-screen bg-black text-white flex items-center justify-center px-6">
      ...
      >
        ...
        <div className="card">
          ...
          <p className="text-white/60 text-center mb-8">Sign in to manage your videos</p>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-white/5 px-3 text-white/40 rounded">or sign in with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleCredentialSignIn} className="space-y-4">
            ...
            <div className="flex justify-end">
              <Link href="/auth/reset-password" className="text-xs text-brand-400 hover:text-brand-300 transition">
                Forgot password?
              </Link>
            </div>
